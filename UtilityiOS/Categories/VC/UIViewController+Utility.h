...
@optional
@property (copy) LIST_ITEM_SELECTED_ACTION_HANDLER selectedActionHandler;
...
- (void)setChildView:(__kindof UIViewController * _Nonnull)childVC forSubView:(UIView * __strong *)view;
