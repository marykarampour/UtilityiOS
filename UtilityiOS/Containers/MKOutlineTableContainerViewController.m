//
//  MKOutlineTableViewController.m
//  KaChing
//
...
#import "MKOutlineTableContainerViewController.h"
#import "UIViewController+Utility.h"
#import "UIView+Utility.h"

@interface MKOutlineTableContainerViewController ()

@property (nonatomic, strong) UIView *backView;

@property (nonatomic, strong, readwrite) UIView *outlineView;
@property (nonatomic, strong, readwrite) UIView *contentView;
@property (nonatomic, strong, readwrite) __kindof MKTableViewController *outlineVC;
...
@implementation MKOutlineTableContainerViewController
...
- (void)setOutlineVC:(__kindof MKTableViewController *)outlineVC {
