//
//  MKPreviewContainerViewController.h
//  Serafa
//
...
@class MKPreviewContainerViewController;
...
@interface MKPreviewContainerViewController : UIViewController

/** @brief main view controller, preview appears over this VC's view */
@property (nonatomic, strong) __kindof UIViewController<MKPreviewProtocol> *mainVC;

@property (nonatomic, strong, readonly) MKPreviewView *preview;
