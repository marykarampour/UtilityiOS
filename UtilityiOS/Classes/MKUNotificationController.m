...
@interface MKUNotificationController ()

@end

@implementation MKUNotificationController

+ (instancetype)instance {
    static MKUNotificationController *note = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        note = [[MKUNotificationController alloc] init];
    });
    return note;
}
