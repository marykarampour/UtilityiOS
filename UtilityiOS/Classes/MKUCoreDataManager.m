...
#import "MKUCoreDataManager.h"
#import "NSObject+Utility.h"

@implementation MKUCoreDataManager
...
- (void)saveItems:(NSArray<__kindof MKUModel *> *)items ofClass:(Class)itemClass entityName:(NSString *)entityName completion:(void (^)(NSError *))completion {
...
- (void)loadItemsOfClass:(Class)itemClass predicate:(NSPredicate *)predicate sortDescriptor:(NSSortDescriptor * )sortDescriptor entityName:(NSString *)entityName completion:(void (^)(NSArray *, NSError *))completion {
    ...
    [self.mainManagedObjectContext performBlock:^{
        ...
        NSMutableArray <MKUModel *> *arr = [[NSMutableArray alloc] init];
...
- (void)loadItemsOfClass:(Class)itemClass inInterval:(__kindof MKUInterval *)interval dateKey:(NSString *)dateKey entityName:(NSString *)entityName ascending:(BOOL)ascending completion:(void (^)(NSArray *, NSError *))completion {
